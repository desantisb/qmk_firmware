...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    KC_NP,             KC_NP,             LT(MEDR, KC_ESC),  LT(MOUR, KC_TAB),  LT(NAVR, KC_SPC),  LT(NSL, KC_ENT),  LT(NSSL, KC_BSPC),  LT(FUNL, KC_DEL),  KC_NP,             KC_NP
  ),
  ...
  [NAVR] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NA,   KC_CAPS, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT,
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_INS,  KC_HOME, KC_PGUP, KC_PGDN, KC_END,
  ...
  [MOUR] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NA,   KC_NU,   KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R,
  ...
  [MEDR] = LAYOUT_miryoku(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NA,   KC_NU,   KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT,
    WINMC,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_NU,   KC_NU,   KC_NU,   KC_NU,   KC_NU,
  ...
  [FUNL] = LAYOUT_miryoku(
    ...
    KC_NP,   KC_NP,   KC_APP,  KC_TAB,  KC_SPC,  KC_NA,   KC_NA,   KC_NA,   KC_NP,   KC_NP
  ),
  [NSL] = LAYOUT_miryoku(
    ...
    KC_NP,   KC_NP,   KC_0,    KC_DOT,  KC_MINS, KC_NA,   KC_NA,   KC_NA,   KC_NP,   KC_NP
  ),
  [NSSL] = LAYOUT_miryoku(
